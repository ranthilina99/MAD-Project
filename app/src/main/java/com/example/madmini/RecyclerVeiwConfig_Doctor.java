...
public class RecyclerVeiwConfig_Doctor {

    private Context mContext;
    private RecyclerVeiwConfig_Doctor.AppointmentAdapter mAppointmentsAdapter;
    public void setConfig(RecyclerView recyclerView, Context context, List<Appoinment> appoinments, List<String> keys){
        mContext = context;
        mAppointmentsAdapter = new RecyclerVeiwConfig_Doctor.AppointmentAdapter(appoinments, keys);
        ...
        public AppointmentItemView(ViewGroup parent) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                   Intent intent = new Intent(mContext, AppoDoctorDetailsActivity.class);
    ...
    class AppointmentAdapter extends RecyclerView.Adapter<AppointmentItemView>{
        ...
        @NonNull
        @Override
        public RecyclerVeiwConfig_Doctor.AppointmentItemView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new RecyclerVeiwConfig_Doctor.AppointmentItemView(parent);
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerVeiwConfig_Doctor.AppointmentItemView holder, int position) {
