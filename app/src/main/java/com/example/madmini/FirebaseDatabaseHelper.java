...
public class FirebaseDatabaseHelper {
    ...
    public FirebaseDatabaseHelper() {
        ...
        /*public void addAppointment(Appoinment appoinment, final DataStatus dataStatus){
    ...
    public void updateAppointment(String key, Appoinment appoinment, final DataStatus dataStatus){
        mReferenceAppointments.child(key).setValue(appoinment)
